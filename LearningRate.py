...
mlp = []
mlp.append(MLPClassifier(hidden_layer_sizes=(200), max_iter=10, random_state=1, activation='relu', learning_rate_init=0.001))
mlp.append(MLPClassifier(hidden_layer_sizes=(200), max_iter=10, random_state=1, activation='relu', learning_rate_init=0.002))
mlp.append(MLPClassifier(hidden_layer_sizes=(200), max_iter=10, random_state=1, activation='relu', learning_rate_init=0.004))
mlp.append(MLPClassifier(hidden_layer_sizes=(200), max_iter=10, random_state=1, activation='relu', learning_rate_init=0.008))
mlp.append(MLPClassifier(hidden_layer_sizes=(200), max_iter=10, random_state=1, activation='relu', learning_rate_init=0.016))


graphingLabels = ['0.001', '0.002', '0.004', '0.008', '0.016']

...
mlp = []
mlp.append(MLPClassifier(max_iter=100, random_state=1, activation='relu'))
mlp.append(MLPClassifier(max_iter=100, random_state=1, activation='logistic'))
mlp.append(MLPClassifier(max_iter=100, random_state=1, activation='identity'))
mlp.append(MLPClassifier(max_iter=100, random_state=1, activation='tanh'))



graphingLabels = ['relu','logistic','identity','tanh']
